...
template <typename T>
using DeleteSmallHeap = DeleteHeap<T, SmallHeap>;
...
int main() {
    ...
    {
        SmallHeap h;
        //SmartPtr<int, DeleteHeap> p{new(&h) int(42), DeleteHeap<int, SmallHeap>(h)}; // 2 template arguments - does not compile
